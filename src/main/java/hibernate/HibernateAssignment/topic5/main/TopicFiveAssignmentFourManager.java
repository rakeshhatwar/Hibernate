...
public class TopicFiveAssignmentFourManager {
	...
	public static void main(String[] args) {
      ...
      listCarDetailsWhichPriceIsLess();
	}
...
/* Method to  READ all Car details */
	private static void listCarDetailsWhichPriceIsLess(){
      ...
      try {
    	 ...
    	 System.out.println("------ List of Car details which price is less than '600000' -----"); 

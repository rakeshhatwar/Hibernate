...
import hibernate.HibernateAssignment.topic6.entity.ContractEmployee6_Ass3;
import hibernate.HibernateAssignment.topic6.entity.EmployeeTopic6_Ass3;
import hibernate.HibernateAssignment.topic6.entity.RegularEmployee6_Ass3;
import hibernate.HibernateAssignment.util.HibernateUtil;

public class TopicSixAssignmentThreeManager {
	...
	public static void main(String[] args) {
	  ...
	  ContractEmployee6_Ass3 contractEmployee2 = new ContractEmployee6_Ass3();
	...
	private static void deleteRegularEmployeeDetails(Integer employeeId){
      ...
      try {
    	 ...
    	 RegularEmployee6_Ass3 employee = (RegularEmployee6_Ass3)session.get(RegularEmployee6_Ass3.class, employeeId);
